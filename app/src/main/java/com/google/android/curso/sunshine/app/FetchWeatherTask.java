...
import com.google.android.curso.sunshine.app.data.WeatherContract;
import com.google.android.curso.sunshine.app.data.WeatherContract.WeatherEntry;
    ...
    String[] convertContentValuesToUXFormat(Vector<ContentValues> cvv) {
        ...
        for (int i = 0; i < cvv.size(); i++) {
            ...
            resultStrs[i] = getReadableDateString(
                    ...
                    " - " + highAndLow +
                    " - " + weatherValues.getAsString(WeatherContract.LocationEntry.COLUMN_CITY_NAME);
        }
        return resultStrs;
    }
