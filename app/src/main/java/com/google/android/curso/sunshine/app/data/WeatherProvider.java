...
public class WeatherProvider extends ContentProvider {
        ...
        switch (match) {
            ...
            case LOCATION: {
                ...
                if (_id > 0)
                    ...
                    throw new SQLException("Failed to insert ro into " + uri);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        final int match = sUriMatcher.match(uri);
        int rowsDeleted;
        //this maks delete all rows return the number of rows deleted.
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER:
                rowsUpdated = db.update(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case LOCATION:
                rowsUpdated = db.update(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
